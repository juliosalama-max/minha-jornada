...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BSyqNB6G.mjs");
...
var manifest = {
	"1b0ac0cec49946a15bba5de64ca5c2092d634b1f80f3fef34ee8d7fe0e610eac": {
		functionName: "getBootstrap_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	},
	"2913e2c0068a16f0b27917b5460d9f4aeef22828b1693b356c31418cb7df3b94": {
		functionName: "saveTasks_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	},
	"339b5a8b92d0bedf055073daa02630900ea672dfcc49be7371147625968a4178": {
		functionName: "saveProfile_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	},
	"455d17bd5d826cd69b3a7718924f6d34c906ced29ba60ae7b51718371d06308f": {
		functionName: "linkPatientByCode_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	},
	"54df7c4dc9564b8f7189fc354ad78c8b737624851236f3f0f62af919b99f7f8c": {
		functionName: "saveOnboarding_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	},
	"7f61b51001e006a2f7bf4f00df9719e502be18e2f18f026c77e97ed0f4d6f009": {
		functionName: "chooseRole_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	},
	"9db50b72520feea187c3eb8feacef7d53ace57c684415294934a28b26761a267": {
		functionName: "saveDayLog_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	},
	"9f1d79ae34595bfdb30c792b5dbdea8db45d2e51751f90308c9eb299840dfaab": {
		functionName: "saveMonthNotes_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	},
	"aa5ff95d6331f253f74bd0df334ace4e78297fbc90d7976a683932668f99a413": {
		functionName: "saveConsults_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	},
	"bfcf546444c8655f7a61eb1ab1f5064394c1b2dcd67a1c6d6bd3406a42320844": {
		functionName: "resetJourney_createServerFn_handler",
		importer: () => import("./journal-api-oX_XQb9-.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-l_Cu-CUH.mjs").then((n) => n.t),
